...
import FCSS from '../assets/tailwind.png';
import JavaScript from '../assets/js1.png';
import ReactImg from '../assets/react.png';
import NodeJS from '../assets/node4.png';
import Express from '../assets/expressjs5.png';
        ...
        <div name='skills' className='w-full h-screen bg-[#0a192f] text-gray-300'>
            ...
            <div className='max-w-[1000px] mx-auto p-4 flex flex-col justify-center w-full h-full'>
                ...
                <div className='w-full grid grid-cols-2 sm:grid-cols-4 gap-4 text-center py-8'>
                    ...
                    <div className='shadow-md shadow-[#040c16] hover:scale-110 duration-500'>
                        <img className='w-20 mx-auto' src={FCSS} alt="CSS icon" />
                        <p className='my-4'>TAILWIND CSS</p>
                    </div>
                    <div className='shadow-md shadow-[#040c16] hover:scale-110 duration-500'>
                        <img className='w-20 mx-auto' src={JavaScript} alt="JavaScripts icon" />
